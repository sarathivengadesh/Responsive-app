...
import Widget from '../Component/widget.tsx'
import SummaryWidget from '../Component/summary-widget.tsx'
...
import CustomBarChart from '../Component/barchart.tsx'
import {OrderItem, TableComponent} from "../Component/Table.tsx"


export default function Home() {
  return (
    <div className='w-full h-screen bg-secondary p-2 overflow-scroll'>
