...
export default function FeedbackSection() {
    ...
    const checkRating =(number)=>{
       return [1,2,3,4,5].map(e => <svg className={`w-3 h-3 ml-1 ${e===number || e<number?"text-yellow-300":"text-gray-500"}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
  ...
  return (
    <div className='m-2 text-white text-start'>
        <div className='h3 mb-2'>Feedback Section</div>
         <div className='scrollbar-webkit h-[300px] overflow-y-scroll '>
